...
В Рекламной сети Яндекс я создал тематическую площадку. Это вызвало у меня трудности, т.к изначально домен game.yandex.ru не был доступен для выбора, но после разговора с технической поддержкой всё заработало. Затем я добавил RTB-блок, и занёс данные о нём в Unity. ![]() ![]()
...
### Bonus
Также, я решил заменить звуковое сопровождение в игре. В качестве музыки я использовал треки, сгенерированные нейросетью [Mubert AI.]()
